  ...
  A.stravaActivities.slice(0, 10).forEach(a => {
    ...
    html += `<div class="strava-activity">
      ...
      <div class="strava-activity-info">
        ...
        <div class="strava-activity-meta">${dateStr}${dist ? ' · ' + dist : ''}${dur ? ' · ' + dur : ''} · <a href="https://www.strava.com/activities/${a.id}" data-strava-open="${a.id}" rel="noopener" style="color:#fc4c02;text-decoration:none;font-weight:600">View in Strava</a></div>
      </div>
      ${isImported
